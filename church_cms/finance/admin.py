...
class AccountAdmin(admin.ModelAdmin):
    list_display  = ('code', 'name', 'account_type', 'parent', 'is_active', 'derived_balance')
...
class JournalEntryAdmin(admin.ModelAdmin):
    list_display   = ('transaction_date', 'description', 'total_debits_display', 'is_balanced', 'posted', 'created_by')
    list_filter    = ('posted', 'transaction_date')
...
class ServiceOfferingAdmin(admin.ModelAdmin):
    list_display    = ('event_name', 'date', 'first_offering', 'tithe', 'thanksgiving', 'total', 'ledger_posted')
    list_filter     = ('date',)
...
class ExpenseRecordAdmin(admin.ModelAdmin):
    list_display   = ('title', 'amount', 'expense_date', 'category', 'fund', 'status', 'created_by', 'approved_by', 'ledger_posted')
    list_filter    = ('status', 'category', 'fund', 'payment_method')
...
class FundAdmin(admin.ModelAdmin):
    list_display  = ('code', 'name', 'status', 'is_restricted', 'assigned_ministry',
                     'opening_balance', 'balance_display', 'total_income_display', 'total_expenses_display')
    list_filter   = ('status', 'is_restricted', 'funding_source')
...
class AuditLogAdmin(admin.ModelAdmin):
    list_display  = ('created_at', 'user', 'action', 'entity_type', 'entity_id', 'description')
